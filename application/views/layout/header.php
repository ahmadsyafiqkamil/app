...
<head>
	...
	<script type="text/javascript" src="<?php echo base_url() ?>/js/plugins/forms/selects/bootstrap_multiselect.js"></script>
	<script type="text/javascript" src="<?php echo base_url() ?>/js/plugins/ui/moment/moment.min.js"></script>
